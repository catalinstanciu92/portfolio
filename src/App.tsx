...
function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary bg-shapes">
      {/* Header */}
      <header 
      ...
      <main className="pt-24">
        ...
        <section id="contact" className="w-full">
          <div className="section-divider max-w-5xl mx-auto px-6" />
          <div className="grid md:grid-cols-2 min-h-[400px]">
            {/* Left Side - Red */}
            <div className="bg-[#FF1801] p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight">
                Let's work
              </h2>
              <p className="text-white/90 text-lg leading-relaxed max-w-md">
                Available for collaborations, freelance engagements, or full-time roles.
              </p>
            </div>
            ...
            <div className="bg-[#1a1a1a] p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              <div className="space-y-6">
                <a 
                  ...
                  className="flex items-center gap-4 text-white hover:text-[#FF1801] transition-colors group"
                >
                  <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:border-[#FF1801] transition-colors">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span className="text-lg">catalinstanciu@live.com</span>
                </a>
